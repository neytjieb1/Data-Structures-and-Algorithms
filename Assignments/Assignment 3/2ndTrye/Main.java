...
/*        testCase1_to_11(tree4);
        ...
        testInsert(tree4, numInserts, false);
        testInsert(tree5, numInserts, false);
        testInsert(tree6, numInserts, false);
        ...
        System.out.println("\n\n=======ORDER4=======");
        t4.print();
        testDelete(t4, true, numInserts);


        /*System.out.println("\n\n=======ORDER5=======");
        t5.print();
        testDelete(t5, false, numInserts);

        System.out.println("\n\n=======ORDER6=======");
        t6.print();
        testDelete(t6, false, numInserts);*/
